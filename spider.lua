...
do
	...
	def2.environment = { 'default:stone', 'mapgen:stone_with_algae', 'mapgen:stone_with_moss', 'mapgen:stone_with_lichen' }
	def2.glow = 2
	...
	def4.environment = { 'default:desert_stone', 'group:sand' }
	def4.hit_dice = 0
	def4.name = 'tarantula'
	def4.size = 0.5
	def4.step_height = 10
